 ...
 */
const CyberShield = () => (
  <div className="absolute right-[-4%] top-1/2 -translate-y-1/2 w-[300px] h-[300px] sm:w-[450px] sm:h-[450px] lg:w-[600px] lg:h-[600px] pointer-events-none opacity-20 sm:opacity-40 hidden sm:block">
