...
// //         <div
// //           ref={scrollRef}
// //           className="flex gap-10 whitespace-nowrap px-6 py-4 text-sm text-gray-500 font-medium overflow-x-hidden"
// //         >
// //           <span>PLATFORMS</span>
...
// //             FineLabs is a digital transformation specialist team, purpose-built to
// //             deliver high-value outcomes across the full enterprise technology stack.
// //           </p>

// //           <div className="mt-10">
// //             <Button
// //               variant="outline"
// //               className="rounded-full px-6 py-6 border-gray-300"
// //             >
// //               Learn more →
// //             </Button>
// //           </div>
...
// //           <div className="relative w-[420px] h-[420px] bg-gray-100 rounded-3xl flex items-center justify-center">

// //             {/* Center Circle */}
// //             <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500" />

// //             {/* Rings */}
// //             <div className="absolute w-40 h-40 rounded-full border border-blue-200" />
// //             <div className="absolute w-56 h-56 rounded-full border border-blue-200" />
// //             <div className="absolute w-72 h-72 rounded-full border border-blue-200" />

// //             {/* Floating Dots */}
// //             <div className="absolute top-16 left-24 w-2 h-2 bg-blue-500 rounded-full" />
// //             <div className="absolute bottom-20 right-24 w-2 h-2 bg-blue-400 rounded-full" />
// //             <div className="absolute top-32 right-16 w-2 h-2 bg-indigo-500 rounded-full" />
...
//     const smoothScroll = () => {
//       position += 0.4; // smaller value = smoother movement
//       el.scrollLeft = position;
...
//           <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-black">
//             Enterprise experience. <br />
//             <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">
//               Lab agility.
//             </span>
...
//           <p className="mt-6 sm:mt-8 text-gray-600 text-sm sm:text-base md:text-lg max-w-xl leading-relaxed mx-auto lg:mx-0">
//             FineLabs is a digital transformation specialist team, purpose-built to
//             deliver high-value outcomes across the full enterprise technology stack.
//           </p>
